@extends('layouts.app')
@section('title')
    {{ config('app_name', 'School MS - About Us') }}
@endsection
@section('content')
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="inner-hmv">
                        ...
                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered
                            ...
                            believable.
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quibusdam eligendi expedita, provident
                            cupiditate in excepturi.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="inner-hmv">
